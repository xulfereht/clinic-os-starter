...
이 문서는 개발자가 아닌 운영자(원장님, 매니저)가 Antigravity AI를 활용해 기능을 추가하거나 콘텐츠를 만들 때, **안전하게 작업을 진행하는 절차**를 설명합니다.
...
*   **Antigravity에게 요청하기**: "새로운 다이어트 프로그램 페이지 만들어줘", "환자 목록에 나이 필드 추가해줘"
...
## 💡 요약
1.  **Antigravity와 작업할 땐 항상 로컬에서 시작하세요.**
