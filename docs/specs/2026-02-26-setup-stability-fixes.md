...
> **⚠️ Historical Spec** — 이 문서의 제안 대부분이 v1.24.2에서 구현되었습니다.
> v1.24.3 추가 개선:
> - setup-clinic.js에서 마이그레이션 실패 시 seeds 캐스케이드 차단 (`migrationFailed` 플래그)
> - `executeWithRetry()`는 setup-clinic.js 내장 + schema-validator.js 모듈 양쪽에서 사용
> - wrangler.toml 전제 조건 검증이 migrate.js에 추가됨
