...
- [ ] npm install 성공
- [ ] setup:step 모든 단계 완료
- [ ] **clinic-profile.json 충족** — phone, address, representative, hours 비어있지 않음
- [ ] **site_settings 실데이터** — clinic_name ≠ '샘플한의원', phone ≠ '02-1234-5678'
- [ ] **staff ≥ 1명** — is_active=1인 의료진 등록됨
- [ ] 온보딩 Tier 1 완료
- [ ] 샘플 데이터(공지/FAQ/후기) 리모트 DB에 시딩
- [ ] 프로그램 최소 3개 이상 등록 + **doctor_ids NOT NULL**
- [ ] 네이버 콘텐츠 추출 (해당 시)
- [ ] npm run build 성공
- [ ] npm run deploy 성공
- [ ] npm run health 통과
