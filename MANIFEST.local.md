...
|-------|------|---------|--------|-----------------|
| `/onboarding` | Orchestrator | Guide full clinic setup (33 features, 5 tiers) — calls sub-skills | ✅ Exists | All |
...
The onboarding system (`.agent/onboarding-registry.json`, 33 features, 5 tiers) is the initial pathway. Skills extend the agent's value **after** onboarding:
