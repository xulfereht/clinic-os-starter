...
| 2c | `/extract-tacit-product` | 원장 인터뷰 (7축) | `tacit-product.yaml` (암묵지) |
| 3 | `/plan-content` | edge-profile, tacit-product, style-card | `site-plan.yaml` (readiness + blog 딥링킹) |
...
| `tacit-product.yaml` | `/extract-tacit-product` | `/write-copy`, `/setup-homepage`, `/setup-programs` |
| `alignment-report.yaml` | `/align-programs` | `/setup-programs` (수정 가이드) |
