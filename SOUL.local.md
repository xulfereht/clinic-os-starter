...
4. `.agent/workflows/first-contact.md` — entry-point detector (identifies new vs returning clinic)
5. `.agent/onboarding-state.json` — what's been set up
6. `clinic.json` — this clinic's identity
7. `.claude/rules/*.md` — auto-loaded guardrails
...
- The full Clinic-OS system: 827 source files, 39 API route groups, 9 skins, 3 plugins
