...
const IS_AUTO = CLI_ARGS.has('--auto') || CLI_ARGS.has('--yes') || CLI_ARGS.has('-y') || !process.stdin.isTTY || process.env.CI === 'true' || process.env.CLINIC_OS_AUTO === 'true' || !!process.env.CLAUDE_CODE || !!process.env.CURSOR_SESSION || !!process.env.CLINE_TASK;
