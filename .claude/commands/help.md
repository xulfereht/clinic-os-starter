...
- User asks what skills or commands are available
- User is unsure which skill to use for their task
- First-time users exploring Clinic-OS capabilities
- User wants a recommended workflow or flow for a connected task
- User asks "what can you do?" or "where do I start?"
