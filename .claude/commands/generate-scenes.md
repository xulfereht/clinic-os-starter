...
- After `/curate-images` identifies missing scene images (treatment, herbal, facility)
- When programs need Hero, Mechanism, or Solution images and no real photos exist
- When filling website image gaps with AI-generated content that matches existing photo tone
- When real photos are available for some programs but not others
...
|---------|-----------|----------------|----------------|
| Chuna/Correction | Available ✅ | Missing ❌ | Missing ❌ |
| Rhinitis Treatment | Missing ❌ | Missing ❌ | Missing ❌ |
| ... | ... | ... | ... |
