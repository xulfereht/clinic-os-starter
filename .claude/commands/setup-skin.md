...
After skin application succeeds and build passes, automatically run `/review-ux` to verify:
- CTA button visibility (WCAG AA contrast 4.5:1)
- Hero text vs background contrast
- Skin CSS vars applied correctly (data-skin selector match)
- Accent color not blending into background

Do NOT skip this step. Visual regressions from skin changes are the #1 client complaint.
