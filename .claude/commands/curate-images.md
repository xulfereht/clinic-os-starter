...
cat > public/local/assets/asset-metadata.json << 'EOF'
{
  ...
  "categories": {
    "portrait_real": {
      "description": "원장/직원 실물 사진",
      "assets": []
    },
    "portrait_card": {
      "description": "카드에서 추출 가능한 인물 사진",
      "assets": []
    },
    "clinic_interior": {
      "description": "한의원 내부 시설",
      "assets": []
    },
    "treatment": {
      "description": "진료/시술 장면",
      "assets": []
    },
    "equipment": {
      "description": "장비/도구",
...
- `/plan-site` — references image gap analysis results
