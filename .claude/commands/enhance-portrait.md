...
- When doctor/staff portrait photos need enhancement to studio-grade quality
- When extracting a person from a design card image for use as a profile photo
- When generating DoctorIntro-optimized portraits (centered, upper body, 4:5 ratio)
- After `/curate-images` identifies portrait_card or low-quality portrait_real images
...
```json
{
  ...
  "notes": "Person extracted from card image, enhanced to studio grade"
}
```
