...
## Auto-trigger: Compliance Review

After copy is written and confirmed, automatically run `/review-compliance` to scan for:
- "전문" without specialist qualification → "집중 진료" / "중심"
- Efficacy assertions ("치료합니다", "제거합니다") → "돕습니다"
- Academic exaggeration ("인정/확인/입증") → "게재/보고"
- Fear-inducing assertions → soften to "~될 수 있습니다"

Fix 🔴 items before delivering. Report 🟡 items to user for decision.
