...
## Auto-trigger: Compliance + UX Review

After all programs are configured and build passes, automatically run:
1. `/review-compliance` — scan program sections text for medical advertising violations
2. `/review-ux` — verify program page rendering, CTA visibility, mobile layout

Fix any 🔴 compliance items before delivering. Report 🟡 items to user.
